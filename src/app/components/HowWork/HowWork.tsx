  ...
  return (
    <section className="overflow-hidden">
      <div className="container relative pb-[140px] pt-[1px] md:flex-col xl:w-auto">
        ...
        <p className="mt-[40px] text-[20px] text-white md:text-[24px] md:w-[377px] xl:w-[419px] ">
        ...
        <div className="relative mt-[105px] h-[307px] ">
          <Image
            className="absolute left-1/2 top-[-60px] z-10 -translate-x-1/2 transform md:w-[144px] md:left-1/3 xl:left-[819px] xl:w-[155px] xl:top-[-90px]"
            priority
            src={woman2}
            height={350}
            width={126}
          ...
          />
          <Image
            className="absolute left-0 z-10 md:top-[-50px] md:w-[125px] xl:w-[125px] xl:left-[541px] xl:top-[-30px]"
            priority
            src={woman2_1}
            height={350}
            width={109}
        ...
        <p className="mt-[70px] text-[20px] text-white md:text-[24px] md:w-[377px] md:self-end xl:w-[419px] xl:mt-[80px]">
          After confirming your ID, you can access all Sister Street features
          and explore our community space.
        </p>

        <div className="relative mt-[174px] h-[307px] xl:mt-[230px  \]">
          <Image
            className="absolute right-[200px] top-[-143px] z-10 md:w-[124px] md:top-[-80px] md:right-[427px] xl:w-[100px] xl:top-[-125px] xl:right-[969px]"
            priority
            src={woman3_1}
            height={250}
            width={77}
          ...
          />
          <Image
            className="absolute right-[74px] top-[-103px] z-10 md:w-[131px] md:right-[212px] md:top-[-90px] xl:w-[155px] xl:right-[740px] xl:top-[-130px]"
            priority
            src={woman3_2}
            height={300}
            width={98}
          ...
          />
          <Image
            className="absolute right-0 top-[-90px] z-10 -mx-[calc(50vw-45%)] md:right-0 md:mx-0 md:w-[163px] xl:w-[135px] xl:right-[562px]"
            priority
            src={woman3_3}
            height={350}
            width={132}
