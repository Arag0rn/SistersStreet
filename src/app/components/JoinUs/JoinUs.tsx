...
export const JoinUs = () =>{
  return (
    <section className="mt-[62px] py-[50px] bg-[#262595] clip-path-custom-clip md:clip-path-custom-clip-none md:py-[40px] xl:clip-path-custom-clip-desktop xl:py-[108px] xl:pb-[180px]">
        <div className='container md:justify-between xl:justify-center gap-[20px]'>
            <div className='md:w-[375px] xl:w-[570px]'>
            <h2 className='mt-[47px] text-[34px] font-bold text-white md:text-[50px] md:leading-[123%] md:mt-0 xl:text-[70px] xl:leading-[120%]'>Join Us And Support Sister Street!</h2>
            <p className='mt-[16px] text-[20px] text-white xl:text[24px]'>We truly value your interest in our team, and we can&apos;t thank you enough for considering joining our team, testing our app, providing feedback, or making a donation.</p>
            <p className='md:mt-[20px] text-[20px] text-white xl:text[24px]'> Whatever the reason for getting in touch, we&apos;re always here to listen and support you. Please feel free to reach out to us anytime.
            </p>
            </div>
            <Formik
        initialValues={{
